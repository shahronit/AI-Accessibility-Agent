 ...
 *
 * Open endpoint (guest-default app); SSRF-validated to prevent internal
 * hostnames being probed via the diff key (the URL is normalised the same
 * way `saveScan` normalises before hashing).
 */
