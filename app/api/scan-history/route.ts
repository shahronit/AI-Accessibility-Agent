 ...
 * `scan:global:history` index. Open endpoint (guest-default app).
 * Pagination params are clamped server side so a malicious caller cannot
 * ask for a million-row page.
 */
